...
Discussion of this work occurs on the [RFC Series Working Group
Editorial Stream Working Group mailing list](mailto:rswg@rfc-editor.org)
([archive](https://mailarchive.ietf.org/arch/browse/rswg/),
[subscribe](https://mailman.rfc-editor.org/mailman/listinfo/rswg)).
...
[Editorial Stream Working Group documents](https://datatracker.ietf.org/edwg/rswg/documents/).
